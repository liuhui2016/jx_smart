...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="orders!list.action?ord_managerno=${ord_managerno}" method="post">
   ...
   <div id="filter" class="filter">
    ...
    <div class="where">
       ...
       <div class="and">
         ...
         <div class="and">
           <span>结束时间:</span>
           	<input type="text" class="small" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="ord_modtime" id = "ord_modtime"/>
        </div>
