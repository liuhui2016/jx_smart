...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="opinon!list.action" method="post">
   ...
   <div id="filter" class="filter">
    ...
    <div class="where">
        <div class="and">
           <span>反馈人:</span>
           <input type="text" class="small" name="filter_LIKES_op_user" value="${param['filter_LIKES_op_user']}" />
        </div>
    </div>
...
<%-- 	  <div><img src="${ctx}/images/b_add.gif" alt="增加" onclick="opr_input('opinon!input.action',false,'${authId}');"/></div> --%>
<%-- 	  <div><img src="${ctx}/images/b_edit.gif" alt="修改" onclick="opr_update('opinon!input.action','mainForm',false,'${authId}');" /></div> --%>
<%-- 	  <div><img src="${ctx}/images/b_del.gif" alt="删除" onclick="opr_delete('opinon!delete.action','mainForm');" /></div> --%>
<!-- 	</div> -->
