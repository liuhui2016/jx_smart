				...
				<tr align="center">
					...
					<td>
						<c:if test="${a.adv_imgurl != null && a.adv_imgurl != ''}">
							<a href="#" id="icondelete" onclick="clsGG('${a.adv_imgurl}');"><img src="${a.adv_imgurl}" width="80" height="40"/></a>
						</c:if>
					</td>
					<td><a href="${a.adv_url}" style="text-decoration:none">${a.adv_url}</a></td>
					<td>
						<c:if test="${a.adv_type == -1}"><a href="advpics!list.action?sup_id=${a.id}" style="text-decoration:none">平板广告</a></c:if>
