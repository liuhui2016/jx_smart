...
$(document).ready(function () {
	$("#filter_EQI_withdrawal_state").attr("value",'${param.filter_EQI_withdrawal_state}');
});
  ...
  <!-- 查询条件 -->
   <div id="filter" class="filter">
    ...
    <div class="where">
        ...
        <div class="and">
           <span>提现人编号:</span>
           	<input type="text" class="small" name="filter_LIKES_user_number" value="${param['filter_LIKES_user_number']}" />
        </div>
        
        <div class="and">
        <span>状态:</span>
	        <select name="filter_EQI_withdrawal_state"  id ="filter_EQI_withdrawal_state" >
	        	<option value="">全部</option>
	        	<option value='0'>待审核</option>
	        	<option value='1'>审核失败</option>
	        	<option value='2'>提现取消</option>
      ...
      <table class="mtab" cellpadding="2" cellspacing="1" border="0">
			...
			<c:forEach items="${page.result}" var="a" varStatus="c">
				<tr align="center">
					...
					<td><a href="trades!lists.action?withdrawal_order=${a.withdrawal_order}">详情</a></td>
