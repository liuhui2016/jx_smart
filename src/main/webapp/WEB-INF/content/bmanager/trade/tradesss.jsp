...
function tn() {
	var state = $('#withdrawal_reason').val();
	var flag = false;
	if(state == null || state == ""){
		$("#reason").text("必须填写原因");
		return flag;
	  ...
	  <div id="content" class="content input">
	    <div id="indiv" style="width:100%;OVERFLOW-X:auto;">
			...
			<table class="tab_cont" width="" cellspacing="0" cellpadding="0" border="0" align="left">
				<tbody>
				    <tr>
				      <th class="first" width="130">失败原因
				      </th>
				      <th class="last" colspan="3"></th>
				    </tr>
				    <tr>
						<td class="right"><span class="red">*</span>失败原因:</td>
						<td colspan="2">
							<input  type="text" name="withdrawal_reason" size="40" id="withdrawal_reason" maxlength="150px" value="${withdrawal_reason}"/>
