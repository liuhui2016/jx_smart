...
<div id="gonggao" class="gonggao" style="display: none">
  ...
  <form id="inputForm" action="trades!updateSaves.action?withdrawal_order=${withdrawal_order}" method="post" enctype="multipart/form-data" >
	  <!-- 列表区域-->
	  <div id="content" class="content input">
	    <div id="indiv" style="width:100%;OVERFLOW-X:auto;">
			...
			<table class="tab_cont" width="" cellspacing="0" cellpadding="0" border="0" align="left">
				<tbody>
				    <tr>
				      <th class="first" width="130">修改返利比例
				      </th>
				      <th class="last" colspan="3"></th>
				    </tr>
				    <tr>
						<td class="right"><span class="red">*</span>返利比例:</td>
						<td colspan="2">
							<input  type="text" name="wdl_fee" size="40" id="wdl_fee" maxlength="150px" value="${wdl_fee}"/>
