  ...
  <!-- 查询条件 -->
   <div id="filter" class="filter">
    ...
    <div class="where">
        ...
        <span>状态:</span>
	        <select name="filter_EQI_ord_status"  id ="filter_EQI_ord_status" >
	        	...
	        	<option value='4' || value = '5'>续费</option>
    ...
    <script language="javascript" type="text/javascript" src="My97DatePicker/WdatePicker.js"></script>
       ...
       <!--  <div class="and">
           	<a href="batch!list.action" style="text-decoration:none"><input type="button" value="批量操作"/></a>
        </div> -->
    </div>
   ...
   <div class="mainC">
   <div><a href="batch!list.action" style="text-decoration:none"><input type="button" value="批量操作"/></a></div>
	<!-- 增删改查...操作菜单-->
      ...
      <table class="mtab" cellpadding="2" cellspacing="1" border="0">
			...
			<c:forEach items="${page.result}" var="a" varStatus="c">
				<tr align="center">
					...
					<td>
						<a href="order!inserinto.action?ord_id=${a.ord_id }" id = "btnShow">加入</a>
					</td>
					</c:if>
						<c:if test="${a.trade_state != 0}">
					<td>
						<a href="#" style="text-decoration:none"><span style="color: #E5E0E0">加入</span></a>
					</td>
					</c:if> --%>
