...
<!-- 	增删改查...操作菜单 -->
	<div id="operate" class="operate">
	  <div><img src="${ctx}/images/b_add.gif" alt="增加" onclick="opr_input(/jx_smart/bmanager/prodetail/prodetail!input.action',false,'${authId}');"/></div>
	  ...
	  <div><img src="${ctx}/images/b_del.gif" alt="删除" onclick="opr_delete('/jx_smart/bmanager/prodetail/prodetail!delete.action','dage');" /></div>
	</div>
