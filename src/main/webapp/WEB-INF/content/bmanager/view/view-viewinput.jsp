...
<div class="container">
  ...
  <form id="gegege" action="view!save.action" method="post" enctype="multipart/form-data" >
			...
			<table class="tab_cont" width="" cellspacing="0" cellpadding="0" border="0" align="left">
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" id="pic_color" name="pic_color" value="${pic_color}" style="width: 320px" />
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" id="pic_tone" name="pic_tone" value="${pic_tone}" style="width: 320px" onchange="toneJudge()"/><span id="toneId" style="color:red"></span>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" id="prod_name" name="prod_name" value="${prod_name}" style="width: 320px" />
						</td>
					</tr>
<!-- 					<tr> -->
...
<!-- 					</tr> -->
					<tr>
						...
						<td colspan="3">
							...
							<input type="hidden" id="pic_urls" name="pic_urls" value="${pic_url}" />
