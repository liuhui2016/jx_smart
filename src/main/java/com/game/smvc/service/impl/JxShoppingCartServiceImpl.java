...
*/
	...
	public List<Map<String, List<Map<String, Object>>>> findAllProduct(
		...
		String sql01 = "select pay_pledge pledge,pay_unitprice unitprice from jx_pay where pay_id = 2 ";
		List<Map<String, Object>> list01 = this.jdbcTemplate.queryForList(sql01);
		Map<String, Object> map01 = list01.get(0);
		int pledge1 =  (Integer) map01.get("pledge");
		Float unitprice1 = (Float) map01.get("unitprice");
		...
		for(int i = 0; i<list1.size();i++){
			...
			int ppdnum1 = (Integer) j.get("ppdnum");
			Float price1 = (Float) j.get("price");
			Float totalPrice1 = (number1*ppdnum1*price1)+(pledge1 * number1);
			if(type1 == 0){
				if(ppdnum1 == 3){
					pledge1 = 0;
		...
		String sql02 = "select pay_pledge pledge,pay_unitprice unitprice from jx_pay where pay_id = 3 ";
		List<Map<String, Object>> list02 = this.jdbcTemplate.queryForList(sql02);
		Map<String, Object> map02 = list02.get(0);
		int pledge2 =  (Integer) map02.get("pledge");
		Float unitprice2 = (Float) map02.get("unitprice");
	...
	@Override
	public Map<String, Object> findUnitprice(String proid, String type) {
		String sql = "select pay_unitprice unitprice from jx_pay where pay_typeid ='"+proid+"' and pay_typename = '"+type+"'";
		return jdbcTemplate.queryForMap(sql);
	}
