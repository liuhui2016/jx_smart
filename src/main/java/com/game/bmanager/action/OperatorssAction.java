...
@Results({ @Result(name = "reload", location = "operatorss.action?id=${id}", type = "redirect") })
public class OperatorssAction extends CrudActionSupport<JxOrder>{
	...
	public String lists() throws Exception {
		System.out.println("ord_managerno:"+ord_managerno);
