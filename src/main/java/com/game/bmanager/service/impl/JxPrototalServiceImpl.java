...
public class JxPrototalServiceImpl extends GenericManagerImpl<JxPrototal, Long> implements IJxPrototalService{
	...
	@Override
	public List<Map<String, Object>> findparams(String proid, String type) {
		String sql = "select P.prot_name name,P.prod_typename typename,P.prod_wx wx,A.pay_pledge pledge,A.pay_unitprice unitprice from jx_prototal P,jx_pay A where prot_type ='"+proid+"' and A.pay_typename = '"+type+"' LIMIT 0,1";
		return jdbcTemplate.queryForList(sql);
	}
