...
<div class="currloca">
  ...
  <div class="sitemap">
   ...
   <form id="mainForm" action="orders!list.action" method="post">
  ...
  <!-- 查询条件 -->
   <div id="filter" class="filter">
    ...
    <div class="where">
       ...
       <div class="and">
        <span>状态:</span>
	       <select id ="filter_EQI_ord_status" name="filter_EQI_ord_status">
       ...
       <div class="and">
        <span>产品类型:</span>
	       <select id ="filter_EQI_pro_id" name="filter_EQI_pro_id">
