...
public class VideoUtil {
    ...
    public static Video getTudouVideo(String url) throws Exception{
            ...
            flash = "http://www.tudou.com/v/" + flash + "/v.mp4";
    ...
    public static Video get56Video(String url) throws Exception{
           ...
           /* int begin = content.indexOf("\"img\":\"");
             ...
             * 获取视频地址
             */
            String flash = "http://player.56.com" + url.substring(url.lastIndexOf("/"), url.lastIndexOf(".html")) + ".mp4";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "http://www.56.com/u34/v_NjY0NzI4NDc.html";
    	//String url = "http://video.tudou.com/v/XMjg0MTIwMDc5Mg==.html?t=1&recoid=17654235836795596138&itemid=8434978726335668110&seccateId=622736331&spm=a2h28.8313461.sec1.dimg_1_2";
        Video video = get56Video(url);
