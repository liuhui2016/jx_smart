...
public class JxAdvpics implements Serializable{
...
/*	@Formula("(select t.menu_name from  jx_menu t where t.id = adv_type)")
	...
	public JxAdvpics(Long id, String adv_phone, String adv_imgurl,
			String adv_dir, String adv_name, Long adv_type, Date adv_vaildtime,
			Date adv_invildtime, Date adv_addtime, Date adv_modtime,
			String adv_url, String adv_other,
			String video_url, String video_dir, String sup_id, int is_accord,
			int video_type) {
		super();
		this.id = id;
		this.adv_phone = adv_phone;
	...
	public String getAdv_other() {
		return adv_other;
	}

	public void setAdv_other(String adv_other) {
		this.adv_other = adv_other;
	}
