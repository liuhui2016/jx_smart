...
@Results({ @Result(name = "reload", location = "ordersss.action?trade_state=${trade_state}&id=${id}&ord_addtime=${ord_addtime}&ord_modtime=${ord_modtime}&ord_status=${ord_status}", type = "redirect") })
public class OrdersssAction extends CrudActionSupport<JxOrder>{
	...
	public String lists() throws Exception {
		...
		page = orderService.searchPagesss(page, filters,ord_addtime,ord_modtime,ord_managerno,trade_state);
		return SUCCESS;
	}
	...
	public String list() throws Exception {
		...
		page = orderService.finOrderOftimeTostatus(page,ord_managerno,time,last_time,page.getPageNo(),page.getPageSize(),trade_state);
		return SUCCESS;
	}
