			...
			if(price1==0){
				...
				if(isAgain == 0){
					...
					if(tags == 0){
						...
						int p_type = 1;
						JxPartnerMessages messages = PushPartnerController.partnerMessage(orderId, content, jxOrderItem.getOdritem_managerno(), p_title,p_type);
						...
						int p_type = 1;
						JxPartnerMessages messages = PushPartnerController.partnerMessage(orderId, content, jxOrder.getOrd_managerno(), p_title,p_type);
						jxPartnerMessagesService.save(messages);
