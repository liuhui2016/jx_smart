...
public enum Errors implements Errcode {
	...
	NO_FILTER_MESSAGES_IN_THE_PROVINCES(3,"暂无该省份滤芯信息"),
	...
	USER_ERROR_NOT_ORDER_OR_NOT_BD(3,"该订单不存在,或者订单未绑定"),
	...
	THERE_IS_NO_MORE_AFTER_SALES_TYPE(101,"暂无更得售后类型！"),
	THIS_ORDER_HAS_BEEN_EVALUATED(101,"该订单已评价!"),
	THE_ORDER_HAS_NOT_BEEN_EVALUATED(101,"此订单尚未评价 !"),
