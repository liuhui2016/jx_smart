...
<div class="container">
  ...
  <div id="message" class="message">
    This shows log persistence status and date queue info...
  </div>  
  ...
  <table class="tab_cont" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
    <tbody>
        <tr>
            <th class="first" width="230" style="color: #ff0000;font-size: 12px;">日志持久化队列</th>
            <th class="last"></th>
        </tr>
    </tbody>
    <tbody id="listSearch">
...
未处理消息的数量：<b>
 <%
    out.print(com.game.modules.queue.QueuesHolder.getQueueLength("log"));
%>
                </b>                </td>
            </tr>
    </tbody>
  ...
  <table class="tab_cont" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
    ...
    <tbody>
        <tr>
            <th class="first" width="230" style="color: #ff0000;font-size: 12px;">数据持久化队列</th>
            <th class="last"></th>
        </tr>
    </tbody>
    <tbody id="listSearch">
            <tr class="mouseout" onmouseout="this.className='mouseout'" onmousemove="this.className='mouseover'">
                <td valign="top" width="20%"></td>
                <td valign="top" style="font-size: 8pt;line-height:22px;">
未处理消息的数量：<b>
 <%
    out.print(com.game.modules.queue.QueuesHolder.getQueueLength("dataQueue"));
%>
                </b>                </td>
            </tr>
    </tbody>
